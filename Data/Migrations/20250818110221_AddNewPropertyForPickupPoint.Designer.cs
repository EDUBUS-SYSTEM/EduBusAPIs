...
namespace Data.Migrations
{
    ...
    [Migration("20250818110221_AddNewPropertyForPickupPoint")]
    partial class AddNewPropertyForPickupPoint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.Admin", b =>
                {
                    b.HasOne("Data.Models.UserAccount", "UserAccount")
                        .WithOne("Admin")
                        .HasForeignKey("Data.Models.Admin", "UserAccountId")
                        .IsRequired();
            ...
            modelBuilder.Entity("Data.Models.Driver", b =>
                {
                    b.HasOne("Data.Models.UserAccount", "UserAccount")
                        .WithOne("Driver")
                        .HasForeignKey("Data.Models.Driver", "UserAccountId")
                        .IsRequired();
            ...
            modelBuilder.Entity("Data.Models.Parent", b =>
                {
                    b.HasOne("Data.Models.UserAccount", "UserAccount")
                        .WithOne("Parent")
                        .HasForeignKey("Data.Models.Parent", "UserAccountId")
                        .IsRequired();
